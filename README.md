...
側邊欄底部有 S / M / L 三個按鈕，分別對應窄、中、寬三種寬度：
...
你可以新增任何網站作為 Destination，包括：

- AI 聊天服務（ChatGPT、Claude、Gemini 等）
- 搜尋引擎
- 特定的 AI 專案頁面（如 Claude Project、ChatGPT GPT、Gemini Gem）
- 任何你經常使用的網站
...
- 切換分頁不會遺失登入狀態
- 解除安裝 Peekabrowser 後，可以手動刪除上述資料夾來清除所有資料
